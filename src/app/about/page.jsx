    ...
    return(
        <div>
            <div className={styles.flexDiv} id={styles.top}>
                ...
                <div><Image className={styles.image} width={400} height={400} src={TopRight} alt="image"></Image></div>
                ...
                <div><br /><br /><Image className={styles.image} width={380} height={240} src={BottomRight} alt="image"></Image></div>
            </div>
        </div>
    )
}
